...
$head_str .= "<script src=\"scripty/js/export_casopisu.js\"></script>";
...
<div id="content" class="redaktor casopisy">
    ...
    ?>
        ...
        <button class="button2" id="add_casopis">Přidat časopis</button>
        ...
        ?>
            <div class="casopis article" id="<?php echo($casopis["id_casopisu"])?>">
                ...
                <div class="control">
                    <button class="button2 c_vis" c_id="<?php echo($casopis["id_casopisu"])?>" c_vis="<?php echo($casopis["zobrazit"])?>">
                    <?php
                    ...
                    if($casopis["pocet_clanku"] > 0) { ?>
                        <button class="button2 c_export" c_id="<?php echo($casopis["id_casopisu"])?>">Exportovat</button>
                    <?php }?>
                </div>
                <div class="left">
